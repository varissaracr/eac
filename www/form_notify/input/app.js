...
let sendData = async (data) => {
    ...
    await axios.post(url + "/notice-eac/save", obj).then((r) => {
        // console.log(r.data.data)
        r.data.data == "success" ? $('#Modalconfirm').modal('show') : null
    })

    // axios.post(url + "/notice-eac/insert/ig_rcord", {
    //     datetimes: obj.data[0].datetimes, record: $('#record').val(), imgfile: dataimgurl,
    // }).then((r) => {
    //     console.log(r.data)
    // })
