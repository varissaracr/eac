...
$(document).ready(function () {
    ...
    table = $('#myTable').DataTable({
        ajax: {
            ...
            url: "https://eec-onep.soc.cmu.ac.th/api/wtrq-api-get-30-bystation.php?stname=station_02&limit=150&fbclid=IwAR3f5-EwPqv97f-iIIQxpmYfiG54DuGKDWrzN5HBe584a6f8V2AQztt-EeA",
        },
        columns: [
            {
                data: null,
