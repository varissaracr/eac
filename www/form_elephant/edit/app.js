...
let getedit = (id_date) => {
    ...
    axios.post(url + `/eac-elephant/getdataone`, { proj_id: id_date }).then(async (r) => {
        ...
        var popup = marker.bindPopup(`<h6><b>ตำแหน่ง</b></h6><span class="kanit-16"> จำนวนที่พบ: ${d[0].num_elephant} ตัว<span>`);
        popup.openPopup();
        ...
        d[0].prov_th !== 'null' ? $('#pro').val(d[0].prov_th) : null;
        d[0].amp_th !== 'null' ? $('#amp').val(d[0].amp_th) : null;
        d[0].tam_th !== 'null' ? $('#tam').val(d[0].tam_th) : null;

        d[0].id_date !== 'null' ? $('#id_date').val(d[0].id_date) : null;
        d[0].num_elephant !== 'null' ? $('#num_elephant').val(d[0].num_elephant).change() : null;
        ...
        d[0].elephant1 !== '' ? $('#elephant1').prop('checked', true) : null;
        d[0].elephant2 !== '' ? $('#elephant2').prop('checked', true) : null;
        d[0].elephant3 !== '' ? $('#elephant3').prop('checked', true) : null;
        d[0].elephant4 !== '' ? $('#elephant4').prop('checked', true) : null;
        d[0].elephant5 !== 'null' ? $('#elephant5').val(d[0].elephant5).change() : null;
...
let sendData = async (data) => {
    ...
    // console.log(data)
    await axios.post(url + "/eac-elephant/update", obj).then((r) => {
